...
func (r *Resolver) start() (chan<- struct{}, error) {
	var err error
	r.c1i, err = clientv3.New(clientv3.Config{
...
func (r *Resolver) watch() {
	...
	r.watchCh = r.c1i.Watch(context.Background(), r.keyPrefix, clientv3.WithPrefix())
...
func (r *Resolver) sync() error {
	...
	defer cancel()
	res, err := r.c1i.Get(ctx, r.keyPrefix, clientv3.WithPrefix())
	if err != nil {
		return err
	}
